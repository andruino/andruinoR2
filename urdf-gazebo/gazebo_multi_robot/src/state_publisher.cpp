...
#include <tf/transform_broadcaster.h>
	...
	double inc=0.005, izqda_inc = 0.005, drcha_inc = 0.005, centro_inc = 0.005; 
       ...
       while (ros::ok()) {
           ...
           joint_state.name.resize(38);
           joint_state.position.resize(38);
	   ...
	   joint_state.name[36] ="odom_base_link";
           joint_state.position[36] = 0;
	   joint_state.name[36] ="IMU_joint";
           joint_state.position[36] = 0;
          ...
          // drcha += drcha_inc;
          // if (drcha<-1.5 || drcha>1.5) drcha_inc *= -1;
	 // centro += centro_inc;
          // if (centro<-1.5 || centro>1.5) centro_inc *= -1;
